...
api_id = '1345519'
api_hash = '4e8ae2501ffa458d403cd6fdb15cc84a'
bot_token = '1378940491:AAGt6XTDX3nlaO7E_mxNCdooHIPiHsVBdN4'
bot = TelegramClient('bot', api_id, api_hash).start(bot_token=bot_token)
print("run")
conn = connect("dataa.db")
'''
cursor = conn.cursor()
cursor.execute("CREATE TABLE IF NOT EXISTS steps(id,step)")
cursor.close()
'''
